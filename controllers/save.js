...
module.exports = function (server) {
	...
	server.post('/save', function (req, res) {
		...
		var roomsData = req.body.rooms;
		console.log('req.body:', req.body);
		console.log('roomsData from req:', roomsData);
        ...
        for(var i=0; i<roomsData.length; i++) {
            var room = new Room(roomsData[i]);
			console.log(roomsData[i]);
            room.save(function (err) {if(err) console.log(err);});
...
//         var bldg17 = new Building({name: "17"});

//         bldg17.save(function(err) {
//             if(err) console.log(err);

//             for(var i=0; i<floorsData.length; i++) {
//                 var floor = new Floor({level:i+1});
//                 var roomsData = floorsData[i];
//                 floor.save(function(err, roomsData) {
//                     if (err) console.log(err);
